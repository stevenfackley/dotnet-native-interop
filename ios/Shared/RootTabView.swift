...
/// 9 tabs. Boundary is the hero/default landing tab; About is demoted to Boundary's toolbar ⓘ (see
/// `AboutToolbarButton`). Search and Analysis are new container screens that reuse the absorbed tabs'
/// existing view bodies unmodified, switched by a segmented control.
