...
internal static class FeatureSqliteExports
{
    ...
    [UnmanagedCallersOnly(EntryPoint = "ondevicellm_sqlite_run")]
    ...
    private static SqliteConnection EnsureConnection()
    {
        ...
        var path = Path.Combine(Path.GetTempPath(), "ondevicellm-features.db");
