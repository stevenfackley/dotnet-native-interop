...
internal static class ExportsFfi
{
    ...
    [UnmanagedCallersOnly(EntryPoint = "ondevicellm_session_start")]
    ...
    /// asynchronously; call <c>ondevicellm_session_free</c> afterward to release resources.
    /// </summary>
    /// <param name="sessionId">Handle returned by <c>ondevicellm_session_start</c>.</param>
    /// <returns><see cref="NativeStatus.Ok"/> or a negative status.</returns>
    [UnmanagedCallersOnly(EntryPoint = "ondevicellm_session_cancel")]
    ...
    /// background pump task drains; call after <c>ondevicellm_session_cancel</c> or after the
    /// final-token callback fires.
    /// </summary>
    /// <param name="sessionId">Handle returned by <c>ondevicellm_session_start</c>.</param>
    /// <returns><see cref="NativeStatus.Ok"/> or a negative status.</returns>
    [UnmanagedCallersOnly(EntryPoint = "ondevicellm_session_free")]
